...
const enumsMap: {[index: string]: any} = {
  ...
  'CardAcquisitionTransaction.LoyaltyHandlingEnum':
    CardAcquisitionTransaction.LoyaltyHandlingEnum,
  'CardAcquisitionTransaction.PaymentTypeEnum':
    CardAcquisitionTransaction.PaymentTypeEnum,
  'CardData.EntryModeEnum': CardData.EntryModeEnum,
  'CardReaderInitRequest.ForceEntryModeEnum':
    CardReaderInitRequest.ForceEntryModeEnum,
  ...
  'LoyaltyAccountId.IdentificationSupportEnum':
    LoyaltyAccountId.IdentificationSupportEnum,
  ...
  'SaleTerminalData.SaleCapabilitiesEnum':
    SaleTerminalData.SaleCapabilitiesEnum,
  'SaleTerminalData.TerminalEnvironmentEnum':
    SaleTerminalData.TerminalEnvironmentEnum,
  ...
  'TransactionConditions.LoyaltyHandlingEnum':
    TransactionConditions.LoyaltyHandlingEnum,
  'TransactionStatusRequest.DocumentQualifierEnum':
    TransactionStatusRequest.DocumentQualifierEnum,
