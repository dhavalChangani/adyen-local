...
export type CharacterHeightType =
  | 'SingleHeight'
  | 'DoubleHeight'
  | 'HalfHeight';
...
export type DocumentQualifierType =
  | 'SaleReceipt'
  | 'CashierReceipt'
  | 'CustomerReceipt'
  | 'Document'
...
export type ErrorConditionType =
  | 'Aborted'
  | 'Busy'
  | 'Cancel'
  | 'DeviceOut'
...
export type ForceEntryModeType =
  | 'RFID'
  | 'Keyed'
  | 'Manual'
  | 'File'
...
export type IdentificationSupportType =
  | 'NoCard'
  | 'LoyaltyCard'
  | 'HybridCard'
  | 'LinkedCard';
...
export type LoyaltyHandlingType =
  | 'Forbidden'
  | 'Processed'
  | 'Allowed'
  | 'Proposed'
...
export type POICapabilitiesType =
  | 'CashierDisplay'
  | 'CashierError'
  | 'CashierInput'
  | 'CustomerDisplay'
...
export type ReversalReasonType =
  | 'CustCancel'
  | 'MerchantCancel'
  | 'Malfunction'
  | 'Unable2Compl';

export type SaleCapabilitiesType =
  | 'CashierStatus'
  | 'CashierError'
  | 'CashierDisplay'
  | 'POIReplication'
...
export type ServiceProfilesType =
  | 'Synchro'
  | 'Batch'
  | 'OneTimeRes'
  | 'Reservation'
...
export type TerminalEnvironmentType =
  | 'Attended'
  | 'SemiAttended'
  | 'Unattended';
